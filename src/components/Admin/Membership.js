...
const Membership = () => {
  ...
  useEffect(()=>{
    axios.get(`${APIURL}/api/adminpremium`)
    .then(response=>{
  ...
  return (
    <div className='bg-white h-screen flex flex-col md:flex-row'>
      ...
      <div className='flex-grow p-5'>
        ...
        {showForm && (
          <div className='fixed inset-0 flex justify-center items-center bg-gray-500 bg-opacity-50'>
            <div className='bg-white p-6 rounded w-96'>
              <h3 className='text-lg font-semibold mb-2'>Add Membership Package</h3>
              <form>
              <div className='mb-4'>
                <label htmlFor='planType' className='block text-gray-700 font-semibold mb-2'>
                  Plan Name
                </label>
                <input
                  type='text'
        ...
        <div className='mb-4'>
            <label htmlFor='planPrice' className='block text-gray-700 font-semibold mb-2'>
                Plan Price (₹)
            </label>
        ...
        <div className='mb-4'>
            <label htmlFor='planValidity' className='block text-gray-700 font-semibold mb-2'>
                Time Period
            </label>
            <select
                value={timeperiod}
        ...
        <div className='flex justify-end mt-4'>
          ...
          <div className='flex flex-wrap'>
            {membershipPackage.map((pk) => (
              ...
              >
                <h3 className='text-lg font-semibold mb-2 text-black'>{pk.plan_name} membership</h3>
